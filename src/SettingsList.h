...
inline const std::vector<SettingInfo>& getSettingsList() {
  static const std::vector<SettingInfo> list = {
      ...
      SettingInfo::Enum(StrId::STR_TRANSPARENT_SLEEP_PNG_BACKGROUND, &CrossPointSettings::transparentSleepPngBackground,
                        {StrId::STR_CURRENT_READING_PAGE, StrId::STR_WHITE_BACKGROUND}, "transparentSleepPngBackground",
      ...
      SettingInfo::Enum(StrId::STR_REFRESH_FREQ, &CrossPointSettings::refreshFrequency,
                        {StrId::STR_PAGES_1, StrId::STR_PAGES_5, StrId::STR_PAGES_10, StrId::STR_PAGES_15,
                         StrId::STR_PAGES_30, StrId::STR_PAGES_NEVER},
      ...
      SettingInfo::Enum(StrId::STR_READER_BACKGROUND_PNG, &CrossPointSettings::readerBackgroundPng,
                        {StrId::STR_NONE_OPT, StrId::STR_FIRST_PNG_IN_BG, StrId::STR_SELECTED}, "readerBackgroundPng"),
      ...
      SettingInfo::Value(StrId::STR_CHARACTER_SPACING, &CrossPointSettings::characterSpacing, {0, 255, 1},
      ...
      SettingInfo::Enum(StrId::STR_READING_LAYOUT, &CrossPointSettings::readingLayout,
                        {StrId::STR_HORIZONTAL_LAYOUT, StrId::STR_VERTICAL_LAYOUT}, "readingLayout",
                        StrId::STR_CAT_READER),
      SettingInfo::Toggle(StrId::STR_EXTRA_SPACING, &CrossPointSettings::extraParagraphSpacing, "extraParagraphSpacing",
                          StrId::STR_CAT_READER),
      SettingInfo::Toggle(StrId::STR_PARAGRAPH_FIRST_LINE_INDENT, &CrossPointSettings::paragraphFirstLineIndent,
  ...
  // --- Controls ---
      ...
      SettingInfo::Enum(StrId::STR_READER_DIRECTION_MODE, &CrossPointSettings::readerOrientationMode,
                        {StrId::STR_FIXED_NORMAL, StrId::STR_FIXED_180, StrId::STR_AUTO_0_180}, "readerOrientationMode",
      ...
      SettingInfo::Toggle(StrId::STR_LONG_PRESS_SKIP, &CrossPointSettings::longPressChapterSkip, "longPressChapterSkip",
                          StrId::STR_CAT_CONTROLS),
      SettingInfo::Toggle(StrId::STR_SWIPE_PAGE_TURN, &CrossPointSettings::swipePageTurnEnabled, "swipePageTurnEnabled",
                          StrId::STR_CAT_CONTROLS),
