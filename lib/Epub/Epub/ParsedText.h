...
class ParsedText {
  ...
  void extractLine(size_t breakIndex, int pageWidth, const std::vector<uint16_t>& wordWidths,
                   ...
                   int fontId, int16_t characterSpacing);
 ...
 public:
  ...
  void layoutAndExtractLines(const GfxRenderer& renderer, int fontId, uint16_t viewportWidth,
                             ...
                             int16_t characterSpacing = 0, bool includeLastLine = true);
  ...
  //   負責從右往左排列。
  void layoutAndExtractColumns(const GfxRenderer& renderer, int fontId, uint16_t viewportHeight, float lineSpacing,
